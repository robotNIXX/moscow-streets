...
2. Generating app's private key<br>
`php artisan key:generate`
3. Jenerate JWT key<br>
...
`cd docker` <br>
`docker-composer build app` <br>
`docker-compose up -d`
2. Now your application is ready on http://localhost:8000/
3. To stop the applciation run `docker-compose down`
