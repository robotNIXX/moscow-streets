<template>
  <div class="reports-list">
    <div class="row">
      <h4 class="col-lg-8 col-md-8">Список задач</h4>
      <a href="#" class="col-lg-4 col-md-4">
    ...
    <div class="list">
      <ul>
        <perfect-scrollbar>
          <li v-for="(item, index) in allTasks">
            ...
            <div class="complete-date-block">
              <label>Время формирования</label>
